...
const HeroSections = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url('https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/claymist-earthy-interior-template/aboutus/hero.png')`,
      }}
    >
      ...
      >
        ...
        <div className="w-[31px] h-[31px] flex justify-center items-center hover:translate-y-[5px] transition-transform duration-200">
          <img
            src={
              "https://69sfgmk1pv2omedb.public.blob.vercel-storage.com/claymist-earthy-interior-template/aboutus/Vector.png"
            }
